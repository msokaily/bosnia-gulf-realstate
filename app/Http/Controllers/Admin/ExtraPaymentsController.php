...
use App\Models\ExtraPayment as TableName;
use App\Models\Realstate;
use Carbon\Carbon;
use Illuminate\Support\Facades\Validator;


class ExtraPaymentsController extends Controller
{
    static $name = 'extra-payments';
    ...
    public function index(Request $request)
    {
        ...
        return view("admin.".self::$name.".home", [
            ...
            'total_buy_km' => $items->whereNotNull('paid_at')->sum('amount_buy_km'),
            'total_sell_km' => $items->whereNotNull('paid_at')->sum('amount_sell_km'),
    ...
    public function store(Request $request)
    {
        ...
        $table->amount_buy_km = request('amount_buy_km');
        $table->amount_sell_km = request('amount_sell_km');
