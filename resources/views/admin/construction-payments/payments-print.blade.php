        ...
        <div class="products">
            <table class="table table-bordered">
                ...
                <tfoot>
                    <tr>
                        <td>ما تم تحويله</td>
                        <td><b dir="ltr">{{ decorate_numbers($total, 0) }}</b> {{$realstate->client->currency}}</td>
                        <td>متبقي البناء</td>
                        <td><b dir="ltr">{{ decorate_numbers($realstate->construction_total - $total, 0) }}</b> {{$realstate->client->currency}}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
