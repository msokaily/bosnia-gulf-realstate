...
-->
<html lang="{{ app()->getLocale() }}" class="{{ getLocale() == 'ar' ? 'rtl' : 'ltr' }}"
...
<head>
    ...
    <meta name="description"
        content="{{ env('APP_NAME') }}: Empowering companies, service providers, and employees with seamless synergy. Unlock growth, collaboration, and success in one innovative platform for the future of business management." />
    <meta name="keywords"
        content="{{ env('APP_NAME') }},manage,business,service,provider,hotel,apartment,room,villa,spa,shop,restaurant" />
    ...
    @if (app()->getLocale() == 'ar')
        ...
        <link href="{{ admin_assets('assets/plugins/global/plugins.bundle.rtl.css') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ admin_assets('assets/css/custom-rtl.css?ver=' . rand(1111, 9999)) }}" rel="stylesheet"
            type="text/css" />
    ...
    @else
        ...
        <link href="{{ admin_assets('assets/css/custom.css?ver=' . rand(1111, 9999)) }}" rel="stylesheet"
            type="text/css" />
    @endif
    <link href="{{ admin_assets('assets/plugins/custom/leaflet/leaflet.bundle.css') }}" rel="stylesheet"
        type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="{{ route('admin.home') }}" class="d-lg-none">
                            <img alt="{{ env('APP_NAME') }}" src="{{ asset('images/favicon.png') }}"
                                class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3">
                                ...
                                <a href="#"
                                    ...
                                    data-kt-menu-placement="{{ dropdown_direction('bottom-end') }}">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ route('admin.admins.edit_password', auth()->guard('admin')->user()->id) }}"
                                            class="menu-link px-5">{{ __('common.Change Password') }}</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
										<div class="separator my-2"></div>
										...
										<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
											<a href="#" class="menu-link px-5">
                                                ...
                                                @if(app()->getLocale() == 'ar')
                                                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">Arabic
                                                        <img class="w-15px h-15px rounded-1 ms-2" src="{{admin_assets('assets/media/flags/saudi-arabia.svg')}}" alt="" />
                                                    </span>
                                                @else
                                                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">English
                                                        <img class="w-15px h-15px rounded-1 ms-2" src="{{admin_assets('assets/media/flags/united-states.svg')}}" alt="" />
                                                    </span>
                                                @endif
                                                </span>
											</a>
											...
											<div class="menu-sub menu-sub-dropdown w-175px py-4">
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}" class="menu-link d-flex px-5 @if(app()->getLocale() == 'en') active @endif">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="{{admin_assets('assets/media/flags/united-states.svg')}}" alt="" />
													</span>English</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													...
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="{{admin_assets('assets/media/flags/saudi-arabia.svg')}}" alt="" />
													</span>Arabic</a>
												</div>
												<!--end::Menu item-->
											</div>
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ route('admin.logout') }}"
                                            class="menu-link px-5">{{ __('siderbar.sign_out') }}</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        <!--begin::Logo image-->
                        <a href="/admin">
                            <img src="{{ asset('images/logo-white.png') }}" alt="{{ env('APP_NAME') }}"
                                style="height: 56px;" class="app-sidebar-logo-default" />
                        </a>
                        <!--end::Logo image-->
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                                ...
                                @if (isSuperAdmin())
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        class="menu-item @if (in_array($uri1, ['settings', 'admins'])) show @endif menu-accordion">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item @if (in_array($uri1, ['settings', 'admins'])) show @endif">
                                                ...
                                                <!--begin:Menu item-->
                                                <div
                                                    class="menu-item @if (in_array($uri1, ['admins'])) show here @endif">
                                                    <!--begin:Menu link-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ url('/admin/home') }}"
                                                class="text-muted text-hover-primary">{{ __('common.control_panel') }}</a>
                                        </li>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <div class="@yield('no_white_bg', 'card') mb-8">
                                    <div class="card-body @yield('no_white_bg', 'pt-9') pb-0">
                                        ...
                                        @endif
                                        @if (session('status'))
                                            <div class="alert alert-success success-msg-alert" role="alert">
                                                {{ session('status') }}!</div>
                                        @endif
                                        @yield('content')
                                    </div>
    ...
    <!--start::Modals-->
    <div id="errors-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn default" data-dismiss="modal"
                        aria-hidden="true">{{ __('common.ok') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if ($("#kt_table_accounts_clients")[0]) {
                handleSearchDatatable1();
            }
        ...
        dt1 = $("#kt_table_accounts_clients").DataTable({
        ...
        var handleSearchDatatable1 = function() {
            const filterSearch = document.querySelector('[data-kt-accounts-table-filter="search"]');
            filterSearch.addEventListener('keyup', function(e) {
